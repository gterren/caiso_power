...
# Process all chunks of data to form a dataset with a given structure
...
# Define data structure to train a global model
def _global_model_structure(X_, Y_):
    X_p_, y_p_ = [], []
    # Concatenate all days in a single column
...
# Convex Climatological Feorecast
