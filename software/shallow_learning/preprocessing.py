...
M_ = _load_spatial_masks(i_resources_,
                         path_to_aux)

# Load proposed data - This task is RAM memory intensive!
# (see manuscript Section Data)
data_ = _load_data_in_chunks([2019, 2020, 2021, 2022, 2023],
                             path_to_raw)
#print(len(data_))
...
# (see SI Section Data Structure)
X_dl_, Y_dl_, g_dl_ = _dense_learning_dataset(X_fc_,
                                              Y_ac_,
                                              Z_,
                                              g_dl_,
                                              N_lags,
