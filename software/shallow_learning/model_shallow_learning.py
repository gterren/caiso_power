...
smoothing_ts_ = ast.literal_eval(exps_.loc[i_exp, "sigmas"])
thetas_       = [theta_, theta_, theta_]
print(thetas_, smoothing_ts_)
...
if calibration:
    S2_dl_ts_hat_, C_dl_ts_bar_ = _calibrate_predictive_covariance(C_dl_ts_hat_, calibration_ts_)
...
_save_dict(_model,
           path_to_mdl,
           file_name = '{}-{}-{}-{}.pkl'.format(resource, sl_method, dl_method, score))
